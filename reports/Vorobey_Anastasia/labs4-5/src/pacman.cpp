...
//    pics[3].push_back(QPixmap(":/img/img/pacmanr2"));
    pics[0].push_back(QPixmap(":/img2/img2/pacmanu1"));
    pics[0].push_back(QPixmap(":/img2/img2/pacmanu2"));
    pics[1].push_back(QPixmap(":/img2/img2/pacmand1"));
    pics[1].push_back(QPixmap(":/img2/img2/pacmand2"));
    pics[2].push_back(QPixmap(":/img2/img2/pacmanl1"));
    pics[2].push_back(QPixmap(":/img2/img2/pacmanl2"));
    pics[3].push_back(QPixmap(":/img2/img2/pacmanr1"));
    pics[3].push_back(QPixmap(":/img2/img2/pacmanr2"));
