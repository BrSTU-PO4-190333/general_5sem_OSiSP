...
Game::Game(QWidget *parent) : QMainWindow(parent)
{
    ...
    menu_style = new QMenu("&Style");
    menu_file_newGame = new QAction("&New game", menu_file);
    menu_file_settings = new QAction("&Settings", menu_file);
    menu_about_action = new QAction("&About", menu_about);
    menu_style_action = new QAction("&Style",menu_style);
    ...
    menu_about->addAction(menu_about_action);
    ...
    QPixmap pix;
    pix.load(":/image/clock.ico");
    lbl_timer->resize(pix.size());
    lbl_timer->setPixmap(pix);
    pix.load(":/image/bomb_6231.ico");
    lbl_countOfMines->resize(pix.size());
    lbl_countOfMines->setPixmap(pix);

    // Read icons.
    firstCheck = false;
    flag =  QIcon(":/image/flag_green.png");
    bomb =  QIcon(":/image/bomb.png");
    one =   QIcon(":/image/one.png");
    two =   QIcon(":/image/two.png");
    three = QIcon(":/image/three.png");
    four =  QIcon(":/image/four.png");
    five =  QIcon(":/image/five.png");
    six =   QIcon(":/image/six.png");
    seven = QIcon(":/image/seven.png");
    eight = QIcon(":/image/eight.png");
    ...
    connect(menu_about_action, &QAction::triggered, this, &Game::menu_about_game);
    connect(menu_style_action, &QAction::triggered, this, &Game::menu_style_game);
}
...
void Game::menu_about_game()
{
    About();
    firstCheck = false;
}
void Game::menu_style_game()
{
    bool Changed;
